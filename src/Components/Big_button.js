...
const tests = [
    ...
    { title: 'Редактировать тест', pageLink: "/Recreate_test_page",color:'outline-dark', id: 2 },
...
export default function Big_button({info}) {
    ...
    return(
        <>
        <center>
            <Accordion style={{maxWidth: '1000px', minWidth: '10px', marginTop:'50px',marginLeft:"2%", marginRight:"2%" }}>
