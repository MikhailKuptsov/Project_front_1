...
import { Row, Col, Button, Accordion, Route  } from "react-bootstrap";

import fabrics_tests from "../Text_data/fabrics_list_data";

const person_test = [
    { title: 'Менеджмент', pageLink: "/test_page_v2/management"},
...
export default function Block_info_2(){
    ...
    return(
        <>
        <center>
            <Accordion style={Block_style} defaultActiveKey="0">
